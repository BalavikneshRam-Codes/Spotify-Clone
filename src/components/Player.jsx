...
function Player() {
  ...
  const {seekBar,seekBg,play,pause,playStatus,track,time,previous,next,seekSonag,handleVolume} = useContext(PlayerContext);
  return (
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
      ...
      <div className="flex flex-col items-center gap-1 m-auto">
        ...
        <div className="flex items-center gap-5">
          ...
          <div ref={seekBg} onClick={(e)=>seekSonag(e)} className="w-[60vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointer">
      ...
      <div className='hidden lg:flex items-center gap-2 opacity-75'>
        ...
        <div>
            <input type="range" name='volume' id='vol' className='w-20 h-1 bg-slate-50 rounded' onInput={(e)=>handleVolume(e)}/>
        </div>
